#### Most of the programs contained within the subdirectories of this project, excluding folders with xcodeproj files, can be easily compiled and run from the command line by:
